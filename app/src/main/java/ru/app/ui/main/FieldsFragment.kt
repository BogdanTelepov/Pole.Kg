...
import ru.app.R
import ru.app.adapters.FieldsAdapter
...
import ru.app.utils.Constants.FILTER_BY_AVERAGE_RATING
...
class FieldsFragment : Fragment(),FieldsAdapter.OnItemClickListener {
    ...
    override fun onCreateView(
        ...
        //val token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJwaG9uZV9udW1iZXIiOiIrOTk2NzA5MDY5MDQ5IiwiZXhwIjoxNjA3NDY1NDM4fQ.QyMSCBC9aJxE5T97P_ALq4eoge_aktPp3CScA-kUZ0o"
                ...
                if (response.isSuccessful) {
                    ...
                    if (response.body()!!.isEmpty()) {
                        ...
                        if (resHelper.size == 0) {
                            ...
                            rootView.rootView.fields_fragment_recycler_view.adapter = fieldsAdapter
                            fieldsAdapter.setFieldsList(resHelper as MutableList<FieldListItem>)
                            rootView.rootView.fields_fragment_recycler_view.startLayoutAnimation()

                            rootView.rootView.fields_fragment_swipe_refresher.isRefreshing = false
                            rootView.rootView.fields_fragment_progressbar.visibility = View.GONE
                        }
    ...
    override fun onItemClick(position: Int, v: View?) {
        ...
        bundle.putString("DATA_PRICE",clickedItem.price)
        ...
        bundle.putBoolean("DISABLE_BOOKING", clickedItem.disableBooking)
