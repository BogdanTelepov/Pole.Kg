...
import ru.app.R
import ru.app.utils.UploadRequestBody
import ru.app.adapters.URIPathHelper
import ru.app.models.addfield.*
...
import ru.app.utils.Constants.IF_EDIT_FRAGMENT
...
import ru.app.utils.getFileName
import java.io.File
...
class AddFieldFragment : Fragment(), UploadRequestBody.UploadCallback  {
    ...
    private fun editField() {
        ...
        if (!fieldPhone.contains("+") || fieldPhone.length < 13 || fieldPhone.length > 13) {
            ...
            // todo add photos from retrofit observer
    ...
    private fun editFieldHours() {
        ...
        val requestBody = AddHoursRequest(editFieldId,workingHour as List<WorkingHourX>)
